...
static const char *fonts[]          = {"FiraCode Nerd Font:style:medium:size=12" ,"FiraCode Nerd Font:style:medium:size=19" };
...
/* tagging */
static char *tags[] = {"󰆍", "", "", "", "", "", "", "󰝚", "󰄛"};
// static char *tags[] = {"", "", "", "", "",};

static const char* eww[] = { "eww", "open" , "eww", NULL };
static const char* qq[] = {"linuxqq", NULL, NULL, NULL};
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_x,  spawn,               SHCMD("setxkbmap -option caps:swapescape")},
    ...
    // overall gaps
    { MODKEY|ControlMask|ShiftMask,     XK_a,       incrgaps,       {.i = +1 } },
